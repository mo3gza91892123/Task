...
num_faive[1].innerHTML = (num_three[1].innerHTML - num_two[1].innerHTML) + "%" //معدل هامش الربح
num_faive[2].innerHTML = num_one[2].innerHTML / num_faive[0].innerHTML //حجم التعادل
num_faive[3].innerHTML = num_one[3].innerHTML / num_faive[0].innerHTML * 100  // قيمة التعادل
num_faive[4].innerHTML = (parseInt(num_one[4].innerHTML) + parseInt(num_four[4].innerHTML)) / num_faive[0].innerHTML //حجم المبيعات
num_faive[5].innerHTML = (parseInt(num_one[5].innerHTML) + parseInt(num_four[5].innerHTML)) / num_faive[0].innerHTML * 100  // قيمة المبيعات